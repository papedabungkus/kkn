...
class Lap_kp_s1_model extends CI_Model
{
     ...
     */
    function get_lap_kp_s1($id_laporan)
    {
     ...
     * Get all lap_kp
     */
    function get_all_lap_kp_s1()
    {
        $this->db->select('*');
        $this->db->from('lap_kp_s1');
        $this->db->join('mahasiswa', 'mahasiswa.nim = lap_kp_s1.nim');
